                ...
                <div class="section__content section__content--p30">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <h3 class="title-5 m-b-35">data pengguna</h3>
                        ...
                        $qu=mysqli_query($conn,"SELECT * FROM tb_user WHERE id_user LIKE '%".$cari."%' OR nama LIKE '%".$cari."%' OR username LIKE '%".$cari."%' ORDER BY id_user $property");
                        while($has=mysqli_fetch_row($qu)){
                                ?>
                                            ...
                                            <tr class="tr-shadow">
                                                ...
                                                <td>
                                                    <span class="block-email"><?php echo $has[3] ;?></span>
                                                </td>
                                                <td class="desc"><?php echo $has[1] ;?></td>
                                               
                                                <td>
                                                    <div class="table-data-feature">                                                
                                                        <a href="pengguna_edit.php?id=<?php echo $has[0];?>">
                                                            <button class="item" data-toggle="tooltip" data-placement="top" title="Edit">
                                                            <i class="zmdi zmdi-edit"></i>
                                                        </button></a>
                                                        <a href="../proses/hapus_pengguna.php?id=<?php echo $has[0];?>">
