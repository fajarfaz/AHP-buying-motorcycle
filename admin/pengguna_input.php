                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        <form action="../proses/registerasi_pengguna.php" method="post" class="">
                                            ...
                                            <div class="form-group">
                                             ...
                                             <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input type="password" id="password" name="password1" placeholder="Konfirmasi Password" class="form-control">
                                                </div>
                                            </div>
