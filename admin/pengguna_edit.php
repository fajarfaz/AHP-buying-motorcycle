            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <?php 
                        $id =  $_GET['id'];
                        $qu=mysqli_query($conn,"SELECT * FROM tb_user WHERE id_user='$id'");
                                        ...
                                        <form action="" method="POST" enctype="multipart/form-data" >
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="username" name="username" placeholder="Username" class="form-control" value="<?php echo $has[1] ;?>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="nama" name="nama" placeholder="Nama Pengguna" class="form-control" value="<?php echo $has[3] ;?>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="input-group">
                                             ...
                                             <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input type="password" id="password" name="password1" placeholder="Konfirmasi Password" class="form-control" readonly>
                                                </div>
                                            </div>
...
if (isset($_POST['kirim'])){
 ...
 $username   = $_POST['username'];
  $sql = "UPDATE tb_user SET `username` = '$username',`nama` = '$nama' WHERE id_user = $id";
                 $result = mysqli_query($conn, $sql);
                 if ($result) 
                 {  
